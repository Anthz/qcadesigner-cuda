...
the second kernel. Register are employed to store local thread variables, and by means of the apposite occupance calculator we verified to not
use more registers than those provided by architecture.

\item \textbf{Coalescence} is another best practice improvement for CUDA code: in consists in make 
