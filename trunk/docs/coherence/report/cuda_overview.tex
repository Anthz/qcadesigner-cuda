...
%Only if this property were enforced in the code the MP could have reduced (to the minimum) the the number of memory accesses needed to provide the data to all the SPs. 
