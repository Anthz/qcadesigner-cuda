...
extern void sorted_cells_to_CUDA_Structures_matrix(QCADCell ***sorted_cells, float **h_polarization, float **h_clock, float ***h_Ek, int ***h_neighbours, int number_of_cell_layers, int *number_of_cells_in_layer, int *neighbours_number){
...
extern void sorted_cells_to_CUDA_Structures_array(QCADCell ***sorted_cells, float **h_polarization, float **h_clock, float **h_Ek, int **h_neighbours, int number_of_cell_layers, int *number_of_cells_in_layer, int* neighbours_number){
